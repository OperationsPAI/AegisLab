...
**data** | [**InjectionResp**](InjectionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseInjectionResp } from 'rcabench-client';

const instance: GenericResponseInjectionResp = {
    code,
    data,
    message,
    timestamp,
