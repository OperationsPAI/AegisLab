...
**data** | [**HealthCheckResp**](HealthCheckResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseHealthCheckResp } from 'rcabench-client';

const instance: GenericResponseHealthCheckResp = {
    code,
    data,
    message,
    timestamp,
