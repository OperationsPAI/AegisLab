...
**data** | [**ListLabelResp**](ListLabelResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListLabelResp } from 'rcabench-client';

const instance: GenericResponseListLabelResp = {
    code,
    data,
    message,
    timestamp,
