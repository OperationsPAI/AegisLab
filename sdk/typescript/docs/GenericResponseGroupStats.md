...
**data** | [**GroupStats**](GroupStats.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseGroupStats } from 'rcabench-client';

const instance: GenericResponseGroupStats = {
    code,
    data,
    message,
    timestamp,
