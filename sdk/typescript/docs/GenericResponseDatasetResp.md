...
**data** | [**DatasetResp**](DatasetResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseDatasetResp } from 'rcabench-client';

const instance: GenericResponseDatasetResp = {
    code,
    data,
    message,
    timestamp,
