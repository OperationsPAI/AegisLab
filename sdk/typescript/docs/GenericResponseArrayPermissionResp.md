...
**data** | [**Array&lt;PermissionResp&gt;**](PermissionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseArrayPermissionResp } from 'rcabench-client';

const instance: GenericResponseArrayPermissionResp = {
    code,
    data,
    message,
    timestamp,
