...
**data** | [**ListUserResp**](ListUserResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListUserResp } from 'rcabench-client';

const instance: GenericResponseListUserResp = {
    code,
    data,
    message,
    timestamp,
