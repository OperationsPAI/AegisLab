...
**data** | [**ListResourceResp**](ListResourceResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListResourceResp } from 'rcabench-client';

const instance: GenericResponseListResourceResp = {
    code,
    data,
    message,
    timestamp,
