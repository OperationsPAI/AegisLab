...
**data** | [**UserInfo**](UserInfo.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseUserInfo } from 'rcabench-client';

const instance: GenericResponseUserInfo = {
    code,
    data,
    message,
    timestamp,
