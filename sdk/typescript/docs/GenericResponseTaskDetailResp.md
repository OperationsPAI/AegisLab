...
**data** | [**TaskDetailResp**](TaskDetailResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseTaskDetailResp } from 'rcabench-client';

const instance: GenericResponseTaskDetailResp = {
    code,
    data,
    message,
    timestamp,
