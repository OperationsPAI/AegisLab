...
**data** | [**ListExecutionResp**](ListExecutionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListExecutionResp } from 'rcabench-client';

const instance: GenericResponseListExecutionResp = {
    code,
    data,
    message,
    timestamp,
