...
**data** | [**PermissionResp**](PermissionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponsePermissionResp } from 'rcabench-client';

const instance: GenericResponsePermissionResp = {
    code,
    data,
    message,
    timestamp,
