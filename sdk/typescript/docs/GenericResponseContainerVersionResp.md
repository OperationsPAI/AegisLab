...
**data** | [**ContainerVersionResp**](ContainerVersionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseContainerVersionResp } from 'rcabench-client';

const instance: GenericResponseContainerVersionResp = {
    code,
    data,
    message,
    timestamp,
