...
**data** | [**LoginResp**](LoginResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseLoginResp } from 'rcabench-client';

const instance: GenericResponseLoginResp = {
    code,
    data,
    message,
    timestamp,
