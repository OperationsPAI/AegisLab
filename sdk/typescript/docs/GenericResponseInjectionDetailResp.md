...
**data** | [**InjectionDetailResp**](InjectionDetailResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseInjectionDetailResp } from 'rcabench-client';

const instance: GenericResponseInjectionDetailResp = {
    code,
    data,
    message,
    timestamp,
