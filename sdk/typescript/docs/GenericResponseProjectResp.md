...
**data** | [**ProjectResp**](ProjectResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseProjectResp } from 'rcabench-client';

const instance: GenericResponseProjectResp = {
    code,
    data,
    message,
    timestamp,
