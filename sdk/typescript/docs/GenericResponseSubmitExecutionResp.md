...
**data** | [**SubmitExecutionResp**](SubmitExecutionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseSubmitExecutionResp } from 'rcabench-client';

const instance: GenericResponseSubmitExecutionResp = {
    code,
    data,
    message,
    timestamp,
