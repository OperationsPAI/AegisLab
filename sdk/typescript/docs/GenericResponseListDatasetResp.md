...
**data** | [**ListDatasetResp**](ListDatasetResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListDatasetResp } from 'rcabench-client';

const instance: GenericResponseListDatasetResp = {
    code,
    data,
    message,
    timestamp,
