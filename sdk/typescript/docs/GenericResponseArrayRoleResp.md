...
**data** | [**Array&lt;RoleResp&gt;**](RoleResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseArrayRoleResp } from 'rcabench-client';

const instance: GenericResponseArrayRoleResp = {
    code,
    data,
    message,
    timestamp,
