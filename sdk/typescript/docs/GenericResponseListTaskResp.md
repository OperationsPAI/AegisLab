...
**data** | [**ListTaskResp**](ListTaskResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseListTaskResp } from 'rcabench-client';

const instance: GenericResponseListTaskResp = {
    code,
    data,
    message,
    timestamp,
