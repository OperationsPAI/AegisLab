...
**data** | [**InjectionMetadataResp**](InjectionMetadataResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseInjectionMetadataResp } from 'rcabench-client';

const instance: GenericResponseInjectionMetadataResp = {
    code,
    data,
    message,
    timestamp,
