...
**data** | [**SystemMetricsResp**](SystemMetricsResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseSystemMetricsResp } from 'rcabench-client';

const instance: GenericResponseSystemMetricsResp = {
    code,
    data,
    message,
    timestamp,
