...
**data** | [**SubmitInjectionResp**](SubmitInjectionResp.md) | Generic type data | [optional] [default to undefined]
...
```typescript
import { GenericResponseSubmitInjectionResp } from 'rcabench-client';

const instance: GenericResponseSubmitInjectionResp = {
    code,
    data,
    message,
    timestamp,
