...
class SSEClient:
    ...
    def get_trace_events(self, trace_id: str) -> Generator[StreamEvent, None, None]:
        ...
        while retries < self.max_retries:
            try:
                ...
                retries += 1
                logger.error(f"Connection error: {e}. Retry {retries}/{self.max_retries}")
    ...
    def filter_events(self, trace_id: str, task_type: Optional[str] = None, 
                     event_name: Optional[str] = None) -> Generator[StreamEvent, None, None]:
        """
