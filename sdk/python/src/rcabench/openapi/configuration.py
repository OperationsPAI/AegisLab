...
class Configuration:
    ...
    conf = rcabench.openapi.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("rcabench.openapi")
    ...
    def get_basic_auth_token(self) -> str | None:
        ...
        return urllib3.make_headers(basic_auth=f"{username}:{password}").get("authorization")
    ...
    def to_debug_report(self) -> str:
        ...
        return (
            ...
            f"Version of the API: {{{{version}}}}\n"
            f"SDK Package Version: {{{{packageVersion}}}}"
        )
