...
class TraceApi:
    ...
    @validate_call
    def api_v1_traces_trace_id_stream_get(
        self,
        trace_id: Annotated[StrictStr, Field(description="跟踪ID")],
        last_id: Annotated[Optional[StrictStr], Field(description="最后接收的消息ID")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        以SSE方式获取指定跟踪ID的实时日志流

        :param trace_id: 跟踪ID (required)
        :type trace_id: str
        :param last_id: 最后接收的消息ID
        :type last_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._api_v1_traces_trace_id_stream_get_serialize(
            trace_id=trace_id,
            last_id=last_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def api_v1_traces_trace_id_stream_get_with_http_info(
        self,
        trace_id: Annotated[StrictStr, Field(description="跟踪ID")],
        last_id: Annotated[Optional[StrictStr], Field(description="最后接收的消息ID")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def api_v1_traces_trace_id_stream_get_without_preload_content(
        self,
        trace_id: Annotated[StrictStr, Field(description="跟踪ID")],
        last_id: Annotated[Optional[StrictStr], Field(description="最后接收的消息ID")] = None,
        _request_timeout: Union[
    ...
    def _api_v1_traces_trace_id_stream_get_serialize(
        self,
        trace_id,
        last_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/traces/{trace_id}/stream',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
