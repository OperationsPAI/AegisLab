...
class DebugApi:
    ...
    def api_v1_debug_ns_status_get(
        ...
        _param = self._api_v1_debug_ns_status_get_serialize(
    ...
    @validate_call
    def api_v1_debug_ns_status_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def api_v1_debug_ns_status_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _api_v1_debug_ns_status_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/debug/ns/status',
