...
class EvaluationsApi:
    ...
    def evaluate_algorithm_on_datapacks(
        self,
        request: Annotated[BatchEvaluateDatapackReq, Field(description="Batch evaluation request containing multiple algorithm-datapack pairs")],
    ...
    def evaluate_algorithm_on_datasets(
        self,
        request: Annotated[BatchEvaluateDatapackReq, Field(description="Batch evaluation request containing multiple algorithm-dataset pairs")],
        _request_timeout: None
        | Annotated[StrictFloat, Field(gt=0)]
        | tuple[Annotated[StrictStr, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
