...
class AlgorithmsApi:
    ...
    @validate_call
    def api_v2_algorithms_execute_batch_post(
        self,
        ...
        _param = self._api_v2_algorithms_execute_batch_post_serialize(
            request=request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def api_v2_algorithms_execute_batch_post_with_http_info(
        self,
        request: Annotated[DtoBatchAlgorithmExecutionRequest, Field(description="Batch algorithm execution request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def api_v2_algorithms_execute_batch_post_without_preload_content(
        self,
        request: Annotated[DtoBatchAlgorithmExecutionRequest, Field(description="Batch algorithm execution request")],
        _request_timeout: Union[
            None,
    ...
    def _api_v2_algorithms_execute_batch_post_serialize(
        self,
        request,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/api/v2/algorithms/execute/batch',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def api_v2_algorithms_execute_post(
        self,
        request: Annotated[DtoAlgorithmExecutionRequest, Field(description="Algorithm execution request")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type request: DtoAlgorithmExecutionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '202': "DtoGenericResponseDtoAlgorithmExecutionResponse",
            '400': "DtoGenericResponseAny",
            '403': "DtoGenericResponseAny",
            '404': "DtoGenericResponseAny",
            '500': "DtoGenericResponseAny",
    ...
    def api_v2_algorithms_execute_post_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DtoGenericResponseDtoAlgorithmExecutionResponse]:
        """Submit algorithm execution
