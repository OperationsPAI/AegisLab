...
from rcabench.openapi.api_response import T as ApiResponseT
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "OpenAPI-Generator/1.1.45/python"
    ...
    def param_serialize(
        ...
        if path_params:
            ...
            parsed_path_params = self.parameters_to_tuples(path_params, collection_formats)
            for k, v in parsed_path_params:
        ...
        return method, url, header_params, body, post_params  # type: ignore
    ...
    def response_deserialize(
        ...
        assert response_types_map is not None, " response type for the response code"
        ...
        try:
            if response_type == "bytearray":
                ...
                return_data = self.deserialize(response_text, response_type, content_type)  # type: ignore
        finally:
    ...
    def deserialize(self, response_text: str, response_type: str, content_type: str | None = None):
        """Deserializes response into an object.
