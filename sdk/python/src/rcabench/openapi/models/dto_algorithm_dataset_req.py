...
class DtoAlgorithmDatasetReq(BaseModel):
    """
    DtoAlgorithmDatasetReq
    """ # noqa: E501
    algorithm: StrictStr
    dataset: StrictStr
    dataset_version: Optional[StrictStr] = Field(default=None, description="Dataset version (optional, defaults to \"v1.0\")")
    tag: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["algorithm", "dataset", "dataset_version", "tag"]
