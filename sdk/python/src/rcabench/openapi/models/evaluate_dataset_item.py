...
class EvaluateDatasetItem(BaseModel):
    ...
    evalaute_refs: list[EvaluateDatapackRef] | None = Field(default=None, description="Evaluation refs for each dataset")
    executed_count: StrictInt | None = Field(default=None, description="Number of successfully executed datapacks")
    total_count: StrictInt | None = Field(default=None, description="Total number of datapacks in dataset")
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["algorithm", "algorithm_version", "dataset", "dataset_version", "evalaute_refs", "executed_count", "total_count"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "evalaute_refs": [EvaluateDatapackRef.from_dict(_item) for _item in obj["evalaute_refs"]] if obj.get("evalaute_refs") is not None else None,
