...
class DtoGenericResponseDtoAlgorithmExecutionResponse(BaseModel):
    """
    DtoGenericResponseDtoAlgorithmExecutionResponse
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[DtoAlgorithmExecutionResponse] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoAlgorithmExecutionResponse.from_dict(obj["data"]) if obj.get("data") is not None else None,
