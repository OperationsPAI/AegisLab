...
class ContainerVersionDetailResp(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["command", "env_vars", "github_link", "helm_config", "id", "image_ref", "name", "updated_at", "usage"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "helm_config": HelmConfigDetailResp.from_dict(obj["helm_config"]) if obj.get("helm_config") is not None else None,
            "id": obj.get("id"),
