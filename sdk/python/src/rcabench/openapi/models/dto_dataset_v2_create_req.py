...
class DtoDatasetV2CreateReq(BaseModel):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * Fields in `self.additional_properties` are added to the output dict.
        ...
        _items = []
        if self.new_labels:
            for _item_new_labels in self.new_labels:
                if _item_new_labels:
                    _items.append(_item_new_labels.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "new_labels": [DtoDatasetV2LabelCreateReq.from_dict(_item) for _item in obj["new_labels"]] if obj.get("new_labels") is not None else None,
            "type": obj.get("type"),
