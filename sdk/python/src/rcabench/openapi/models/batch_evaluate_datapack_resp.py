...
class BatchEvaluateDatapackResp(BaseModel):
    """
    BatchEvaluateDatapackResp
    """ # noqa: E501
    failed_count: StrictInt | None = None
    failed_items: list[StrictStr] | None = None
    success_count: StrictInt | None = None
    success_items: list[EvaluateDatapackItem] | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["failed_count", "failed_items", "success_count", "success_items"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "success_items": [EvaluateDatapackItem.from_dict(_item) for _item in obj["success_items"]] if obj.get("success_items") is not None else None
        })
