...
class DtoBatchAlgorithmExecutionResponse(BaseModel):
    """
    DtoBatchAlgorithmExecutionResponse
    """ # noqa: E501
    executions: Optional[List[DtoAlgorithmExecutionResponse]] = None
    group_id: Optional[StrictStr] = None
    message: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["executions", "group_id", "message"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "executions": [DtoAlgorithmExecutionResponse.from_dict(_item) for _item in obj["executions"]] if obj.get("executions") is not None else None,
