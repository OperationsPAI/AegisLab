...
class UploadExecutionResultResp(BaseModel):
    """
    UploadExecutionResultResp
    """  # noqa: E501

    has_anomalies: StrictBool | None = Field(default=None, description="Only included for detector results")
    result_count: StrictInt | None = None
    uploaded_at: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["has_anomalies", "result_count", "uploaded_at"]
