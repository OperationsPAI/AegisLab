...
class SubmitInjectionItem(BaseModel):
    """
    SubmitInjectionItem
    """  # noqa: E501
    ...
    __properties: ClassVar[list[str]] = ["index", "task_id", "trace_id"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"index": obj.get("index"), "task_id": obj.get("task_id"), "trace_id": obj.get("trace_id")}
        )
