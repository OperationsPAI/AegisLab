...
class SubmitDatapackBuildingResp(BaseModel):
    """
    SubmitDatapackBuildingResp
    """ # noqa: E501
    group_id: StrictStr | None = None
    items: list[SubmitBuildingItem] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SubmitBuildingItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
