...
class ChaosResourceField(BaseModel):
    """
    ChaosResourceField
    """  # noqa: E501

    index_name: StrictStr | None = None
    name: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["index_name", "name"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({"index_name": obj.get("index_name"), "name": obj.get("name")})
