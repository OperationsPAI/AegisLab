...
class SubmitContainerBuildResp(BaseModel):
    """
    ...
    __properties: ClassVar[list[str]] = ["group_id", "task_id", "trace_id"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {"group_id": obj.get("group_id"), "task_id": obj.get("task_id"), "trace_id": obj.get("trace_id")}
        )
