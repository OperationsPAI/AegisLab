...
class DtoDatasetEvaluationBatchReq(BaseModel):
    """
    DtoDatasetEvaluationBatchReq
    """ # noqa: E501
    items: List[DtoAlgorithmDatasetReq]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "items": [DtoAlgorithmDatasetReq.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
