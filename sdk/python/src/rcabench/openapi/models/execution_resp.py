...
class ExecutionResp(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["algorithm_id", "algorithm_name", "algorithm_version", "algorithm_version_id", "created_at", "datapack_id", "datapack_name", "duration", "id", "labels", "state", "status", "task_id", "updated_at"]
