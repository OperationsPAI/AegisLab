...
class BatchEvaluateDatapackReq(BaseModel):
    """
    BatchEvaluateDatapackReq
    """ # noqa: E501
    specs: list[EvaluateDatapackSpec]
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["specs"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "specs": [EvaluateDatapackSpec.from_dict(_item) for _item in obj["specs"]] if obj.get("specs") is not None else None
        })
