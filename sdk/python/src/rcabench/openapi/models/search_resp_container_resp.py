...
class SearchRespContainerResp(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "items": [ContainerResp.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
