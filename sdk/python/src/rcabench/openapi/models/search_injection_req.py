...
class SearchInjectionReq(BaseModel):
    ...
    def sort_by_validate_enum(cls, value):
        ...
        if value not in set(['id', 'task_id', 'fault_type', 'status', 'benchmark', 'injection_name', 'created_at', 'updated_at']):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "labels": [LabelItem.from_dict(_item) for _item in obj["labels"]] if obj.get("labels") is not None else None,
            "page": obj.get("page"),
