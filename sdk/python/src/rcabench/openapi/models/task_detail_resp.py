...
class TaskDetailResp(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["created_at", "cron_expr", "execute_time", "group_id", "id", "immediate", "logs", "payload", "project_id", "project_name", "state", "status", "trace_id", "type", "updated_at"]
