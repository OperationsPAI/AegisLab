...
class CreateDatasetReq(BaseModel):
    ...
    name: StrictStr
    type: StrictStr
    version: CreateDatasetVersionReq | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["description", "is_public", "name", "type", "version"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "name": obj.get("name"),
            "type": obj.get("type"),
            "version": CreateDatasetVersionReq.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
