...
class HelmConfigDetailResp(BaseModel):
    """
    HelmConfigDetailResp
    """  # noqa: E501

    full_chart: StrictStr | None = None
    id: StrictInt | None = None
    ns_prefix: StrictStr | None = None
    port_template: StrictStr | None = None
    repo_url: StrictStr | None = None
    values: dict[str, dict[str, Any]] | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["full_chart", "id", "ns_prefix", "port_template", "repo_url", "values"]
