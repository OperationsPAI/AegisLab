...
class DtoAlgorithmExecutionResponse(BaseModel):
    """
    DtoAlgorithmExecutionResponse
    """ # noqa: E501
    algorithm_id: Optional[StrictInt] = None
    datapack_id: Optional[StrictInt] = None
    dataset_id: Optional[StrictInt] = None
    status: Optional[StrictStr] = None
    task_id: Optional[StrictStr] = None
    trace_id: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["algorithm_id", "datapack_id", "dataset_id", "status", "task_id", "trace_id"]
