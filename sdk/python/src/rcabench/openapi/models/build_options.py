...
class BuildOptions(BaseModel):
    ...
    context_dir: StrictStr | None = '.'
    dockerfile_path: StrictStr | None = 'Dockerfile'
    force_rebuild: StrictBool | None = None
    target: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["build_args", "context_dir", "dockerfile_path", "force_rebuild", "target"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "context_dir": obj.get("context_dir") if obj.get("context_dir") is not None else '.',
            "dockerfile_path": obj.get("dockerfile_path") if obj.get("dockerfile_path") is not None else 'Dockerfile',
