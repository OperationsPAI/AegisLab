...
class ContainerDetailResp(BaseModel):
    """
    ContainerDetailResp
    """ # noqa: E501
    ...
    versions: list[ContainerVersionResp] | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["created_at", "id", "is_public", "labels", "name", "readme", "status", "type", "updated_at", "versions"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "versions": [ContainerVersionResp.from_dict(_item) for _item in obj["versions"]] if obj.get("versions") is not None else None
        })
