...
class ChaosGroundtruth(BaseModel):
    """
    ChaosGroundtruth
    """  # noqa: E501

    container: list[StrictStr] | None = None
    function: list[StrictStr] | None = None
    metric: list[StrictStr] | None = None
    pod: list[StrictStr] | None = None
    service: list[StrictStr] | None = None
    span: list[StrictStr] | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["container", "function", "metric", "pod", "service", "span"]
