...
class ContainerSpec(BaseModel):
    ...
    ContainerSpec
    """ # noqa: E501
    env_vars: list[ParameterSpec] | None = None
    name: StrictStr
    version: StrictStr | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["env_vars", "name", "version"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "env_vars": [ParameterSpec.from_dict(_item) for _item in obj["env_vars"]] if obj.get("env_vars") is not None else None,
            "name": obj.get("name"),
