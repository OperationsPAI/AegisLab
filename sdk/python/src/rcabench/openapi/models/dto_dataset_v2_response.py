...
class DtoDatasetV2Response(BaseModel):
    ...
    injections: Optional[List[DtoDatasetV2InjectionRelationResponse]] = Field(default=None, description="Associated fault injections")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "injections": [DtoDatasetV2InjectionRelationResponse.from_dict(_item) for _item in obj["injections"]] if obj.get("injections") is not None else None,
