...
class GenericResponseListTaskResp(BaseModel):
    """
    GenericResponseListTaskResp
    """  # noqa: E501

    code: StrictInt | None = Field(default=None, description="Status code")
    data: ListTaskResp | None = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "code": obj.get("code"),
                "data": ListTaskResp.from_dict(obj["data"]) if obj.get("data") is not None else None,
