...
class ProjectDetailResp(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["containers", "created_at", "datapacks", "datasets", "description", "id", "is_public", "labels", "name", "status", "updated_at", "user_count"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "containers": [ContainerResp.from_dict(_item) for _item in obj["containers"]] if obj.get("containers") is not None else None,
            "created_at": obj.get("created_at"),
            "datapacks": [InjectionResp.from_dict(_item) for _item in obj["datapacks"]] if obj.get("datapacks") is not None else None,
            "datasets": [DatasetResp.from_dict(_item) for _item in obj["datasets"]] if obj.get("datasets") is not None else None,
