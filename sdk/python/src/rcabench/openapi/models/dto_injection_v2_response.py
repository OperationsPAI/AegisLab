...
class DtoInjectionV2Response(BaseModel):
    """
    ...
    task: Optional[DtoTaskV2Response] = Field(default=None, description="Optional relations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "task": DtoTaskV2Response.from_dict(obj["task"]) if obj.get("task") is not None else None,
