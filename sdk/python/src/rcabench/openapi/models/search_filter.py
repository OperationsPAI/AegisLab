...
class SearchFilter(BaseModel):
    ...
    operator: FilterOperator = Field(description="Operator")
    value: StrictStr | None = Field(default=None, description="Value (can be string, number, boolean, etc.)")
    values: list[StrictStr] | None = Field(default=None, description="Multiple values (for IN operations etc.)")
