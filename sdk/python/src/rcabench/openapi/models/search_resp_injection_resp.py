...
class SearchRespInjectionResp(BaseModel):
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "applied_filters": [SearchFilter.from_dict(_item) for _item in obj["applied_filters"]]
                if obj.get("applied_filters") is not None
                else None,
                "applied_sort": [SortOption.from_dict(_item) for _item in obj["applied_sort"]]
                if obj.get("applied_sort") is not None
                else None,
                "items": [InjectionResp.from_dict(_item) for _item in obj["items"]]
                if obj.get("items") is not None
                else None,
                "pagination": PaginationInfo.from_dict(obj["pagination"])
