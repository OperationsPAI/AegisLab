...
class SubmitBuildContainerReq(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["build_options", "github_branch", "github_commit", "github_repository", "github_token", "image_name", "sub_path", "tag"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            "build_options": BuildOptions.from_dict(obj["build_options"]) if obj.get("build_options") is not None else None,
