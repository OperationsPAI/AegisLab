...
class BatchEvaluateDatasetResp(BaseModel):
    """
    ...
    success_items: list[EvaluateDatasetItem] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "success_items": [EvaluateDatasetItem.from_dict(_item) for _item in obj["success_items"]] if obj.get("success_items") is not None else None
        })
