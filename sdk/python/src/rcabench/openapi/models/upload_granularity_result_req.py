...
class UploadGranularityResultReq(BaseModel):
    """
    UploadGranularityResultReq
    """ # noqa: E501
    duration: StrictFloat | StrictInt = Field(description="Execution duration in seconds")
    results: list[GranularityResultItem]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GranularityResultItem.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
