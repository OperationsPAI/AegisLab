...
class InjectionWithIssuesResp(BaseModel):
    ...
    __properties: ClassVar[list[str]] = ["abnormal_avg_duration", "abnormal_p99", "abnormal_succ_rate", "datapack_id", "datapack_name", "engine_config", "issues", "normal_avg_duration", "normal_p99", "normal_succ_rate"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "engine_config": ChaosNode.from_dict(obj["engine_config"]) if obj.get("engine_config") is not None else None,
