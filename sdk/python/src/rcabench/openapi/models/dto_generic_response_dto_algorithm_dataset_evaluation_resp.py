...
class DtoGenericResponseDtoAlgorithmDatasetEvaluationResp(BaseModel):
    ...
    data: Optional[DtoAlgorithmDatasetEvaluationResp] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": DtoAlgorithmDatasetEvaluationResp.from_dict(obj["data"]) if obj.get("data") is not None else None,
