...
class InjectionDetailResp(BaseModel):
    ...
    display_config: StrictStr | None = None
    end_time: StrictStr | None = None
    engine_config: StrictStr | None = None
    fault_type: StrictStr | None = None
    ground_truth: ChaosGroundtruth | None = None
    ...
    __properties: ClassVar[list[str]] = ["benchmark_id", "benchmark_name", "created_at", "description", "display_config", "end_time", "engine_config", "fault_type", "ground_truth", "id", "labels", "name", "pedestal_id", "pedestal_name", "pre_duration", "start_time", "state", "status", "task_id", "updated_at"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "ground_truth": ChaosGroundtruth.from_dict(obj["ground_truth"]) if obj.get("ground_truth") is not None else None,
            "id": obj.get("id"),
