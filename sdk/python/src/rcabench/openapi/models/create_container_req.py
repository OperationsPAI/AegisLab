...
class CreateContainerReq(BaseModel):
    ...
    version: CreateContainerVersionReq | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["is_public", "name", "readme", "type", "version"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "type": obj.get("type"),
            "version": CreateContainerVersionReq.from_dict(obj["version"]) if obj.get("version") is not None else None
        })
