...
class DtoGenericResponseDtoDatapackEvaluationBatchResp(BaseModel):
    """
    DtoGenericResponseDtoDatapackEvaluationBatchResp
    """ # noqa: E501
    code: Optional[StrictInt] = Field(default=None, description="Status code")
    data: Optional[List[DtoAlgorithmDatapackResp]] = Field(default=None, description="Generic type data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "data": [DtoAlgorithmDatapackResp.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
