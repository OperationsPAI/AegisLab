...
class ChaosNode(BaseModel):
    """
    ChaosNode
    """  # noqa: E501

    children: dict[str, ChaosNode] | None = None
    description: StrictStr | None = None
    name: StrictStr | None = None
    range: list[StrictInt] | None = None
    value: StrictInt | None = None
    additional_properties: dict[str, Any] = {}
    __properties: ClassVar[list[str]] = ["children", "description", "name", "range", "value"]
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate(
            {
                "children": dict((_k, ChaosNode.from_dict(_v)) for _k, _v in obj["children"].items())
...
ChaosNode.model_rebuild(raise_errors=False)
