...
class SubmitExecutionResp(BaseModel):
    """
    SubmitExecutionResp
    """ # noqa: E501
    group_id: StrictStr | None = None
    items: list[SubmitExecutionItem] | None = None
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "items": [SubmitExecutionItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
