...
class DtoInjectionRef(BaseModel):
    """
    DtoInjectionRef
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="Injection ID")
    name: Optional[StrictStr] = Field(default=None, description="Injection name")
