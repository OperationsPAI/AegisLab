...
type executionSubmitterStub struct {
	resp            *executionmodule.SubmitExecutionResp
	id              int
	item            *executionmodule.ExecutionDetailResp
	evaluationItems []executionmodule.EvaluationExecutionItem
	err             error
}

func (s executionSubmitterStub) SubmitAlgorithmExecution(_ context.Context, req *executionmodule.SubmitExecutionReq, groupID string, userID int) (*executionmodule.SubmitExecutionResp, error) {
...
func (s executionSubmitterStub) CreateExecutionRecord(_ context.Context, req *executionmodule.RuntimeCreateExecutionReq) (int, error) {
...
func (s executionSubmitterStub) UpdateExecutionState(_ context.Context, req *executionmodule.RuntimeUpdateExecutionStateReq) error {
...
func (s executionSubmitterStub) GetExecution(_ context.Context, executionID int) (*executionmodule.ExecutionDetailResp, error) {
	if executionID <= 0 {
...
func (s executionSubmitterStub) ListEvaluationExecutionsByDatapack(_ context.Context, req *executionmodule.EvaluationExecutionsByDatapackReq) ([]executionmodule.EvaluationExecutionItem, error) {
...
func (s executionSubmitterStub) ListEvaluationExecutionsByDataset(_ context.Context, req *executionmodule.EvaluationExecutionsByDatasetReq) ([]executionmodule.EvaluationExecutionItem, error) {
...
type injectionSubmitterStub struct {
	injectionResp *injectionmodule.SubmitInjectionResp
	buildResp     *injectionmodule.SubmitDatapackBuildingResp
	item          *dto.InjectionItem
	err           error
}

func (s injectionSubmitterStub) SubmitFaultInjection(_ context.Context, req *injectionmodule.SubmitInjectionReq, groupID string, userID int, projectID *int) (*injectionmodule.SubmitInjectionResp, error) {
...
func (s injectionSubmitterStub) SubmitDatapackBuilding(_ context.Context, req *injectionmodule.SubmitDatapackBuildingReq, groupID string, userID int, projectID *int) (*injectionmodule.SubmitDatapackBuildingResp, error) {
...
func (s injectionSubmitterStub) CreateInjectionRecord(_ context.Context, req *injectionmodule.RuntimeCreateInjectionReq) (*dto.InjectionItem, error) {
...
func (s metricsReaderStub) GetInjectionMetrics(_ context.Context, req *metricmodule.GetMetricsReq) (*metricmodule.InjectionMetrics, error) {
	if req == nil {
...
func (s metricsReaderStub) GetExecutionMetrics(_ context.Context, req *metricmodule.GetMetricsReq) (*metricmodule.ExecutionMetrics, error) {
	if req == nil {
		return nil, errors.New("nil request")
	}
...
func (s injectionSubmitterStub) UpdateInjectionState(_ context.Context, req *injectionmodule.RuntimeUpdateInjectionStateReq) error {
	if req.Name == "" {
...
func (s injectionSubmitterStub) UpdateInjectionTimestamps(_ context.Context, req *injectionmodule.RuntimeUpdateInjectionTimestampReq) (*dto.InjectionItem, error) {
	if req.Name == "" {
...
type taskReaderStub struct {
	detail *taskmodule.TaskDetailResp
	list   *dto.ListResp[taskmodule.TaskResp]
	err    error
}

func (s taskReaderStub) GetDetail(_ context.Context, taskID string) (*taskmodule.TaskDetailResp, error) {
	if taskID == "" {
...
func (s taskReaderStub) PollLogs(_ context.Context, taskID string, _ time.Time) (*taskmodule.TaskLogPollResp, error) {
	if taskID == "" {
		return nil, errors.New("missing task id")
	}
...
func (s taskReaderStub) List(_ context.Context, req *taskmodule.ListTaskReq) (*dto.ListResp[taskmodule.TaskResp], error) {
	if req == nil {
		return nil, errors.New("nil request")
	}
	return s.list, s.err
...
type traceReaderStub struct {
	detail     *tracemodule.TraceDetailResp
	list       *dto.ListResp[tracemodule.TraceResp]
	algorithms []dto.ContainerVersionItem
	messages   []redis.XStream
	err        error
}

func (s traceReaderStub) GetTrace(_ context.Context, traceID string) (*tracemodule.TraceDetailResp, error) {
	if traceID == "" {
...
func (s traceReaderStub) ListTraces(_ context.Context, req *tracemodule.ListTraceReq) (*dto.ListResp[tracemodule.TraceResp], error) {
	if req == nil {
		return nil, errors.New("nil request")
	}
	return s.list, s.err
...
type groupReaderStub struct {
	stats    *groupmodule.GroupStats
	count    int64
	messages []redis.XStream
	err      error
}

func (s groupReaderStub) GetGroupStats(_ context.Context, req *groupmodule.GetGroupStatsReq) (*groupmodule.GroupStats, error) {
...
func TestOrchestratorServerSubmitExecution(t *testing.T) {
	server := &orchestratorServer{
		execution: executionSubmitterStub{resp: &executionmodule.SubmitExecutionResp{
			GroupID: "group-1",
			Items: []executionmodule.SubmitExecutionItem{{
				Index:              0,
				TraceID:            "trace-1",
				TaskID:             "task-1",
				AlgorithmID:        11,
...
func TestOrchestratorServerSubmitFaultInjection(t *testing.T) {
	server := &orchestratorServer{
		...
		injection: injectionSubmitterStub{injectionResp: &injectionmodule.SubmitInjectionResp{
			GroupID:       "group-2",
			OriginalCount: 1,
			Items: []injectionmodule.SubmitInjectionItem{{
				Index:   0,
				TraceID: "trace-2",
				TaskID:  "task-2",
			}},
			Warnings: &injectionmodule.InjectionWarnings{
...
func TestOrchestratorServerRuntimeMutations(t *testing.T) {
	...
	server := &orchestratorServer{
		execution: executionSubmitterStub{
			id: 22,
			item: &executionmodule.ExecutionDetailResp{
				ExecutionResp: executionmodule.ExecutionResp{ID: 22},
			},
			evaluationItems: []executionmodule.EvaluationExecutionItem{{
				Datapack: "dp-1",
				ExecutionRef: executionmodule.ExecutionRef{
					ExecutionID: 22,
				},
			}},
		},
		...
		metrics: metricsReaderStub{
			injection: &metricmodule.InjectionMetrics{TotalCount: 3},
			execution: &metricmodule.ExecutionMetrics{TotalCount: 4},
		},
		tasks:     taskControllerStub{},
		taskRead:  taskReaderStub{},
		traceRead: traceReaderStub{},
...
func TestOrchestratorServerGetTask(t *testing.T) {
	server := &orchestratorServer{
		...
		metrics:   metricsReaderStub{},
		tasks:     taskControllerStub{},
		taskRead: taskReaderStub{detail: &taskmodule.TaskDetailResp{
			TaskResp: taskmodule.TaskResp{
				ID:    "task-1",
				Type:  consts.GetTaskTypeName(consts.TaskTypeRunAlgorithm),
				State: consts.GetTaskStateName(consts.TaskPending),
			},
...
func TestOrchestratorServerListTasks(t *testing.T) {
	server := &orchestratorServer{
		...
		metrics:   metricsReaderStub{},
		tasks:     taskControllerStub{},
		taskRead: taskReaderStub{list: &dto.ListResp[taskmodule.TaskResp]{
			Items: []taskmodule.TaskResp{{ID: "task-1"}},
...
func TestOrchestratorServerGetTrace(t *testing.T) {
	server := &orchestratorServer{
		...
		tasks:     taskControllerStub{},
		taskRead:  taskReaderStub{},
		traceRead: traceReaderStub{detail: &tracemodule.TraceDetailResp{
			TraceResp: tracemodule.TraceResp{
				ID:        "trace-1",
				Type:      "full_pipeline",
				GroupID:   "group-1",
...
func TestOrchestratorServerListTraces(t *testing.T) {
	server := &orchestratorServer{
		...
		tasks:     taskControllerStub{},
		taskRead:  taskReaderStub{},
		traceRead: traceReaderStub{list: &dto.ListResp[tracemodule.TraceResp]{
			Items: []tracemodule.TraceResp{{ID: "trace-1"}},
			Pagination: &dto.PaginationInfo{
				Page: 1, Size: 20, Total: 1, TotalPages: 1,
			},
		}},
...
func TestOrchestratorServerGetGroupStats(t *testing.T) {
	server := &orchestratorServer{
		...
		taskRead:  taskReaderStub{},
		traceRead: traceReaderStub{},
		groupRead: groupReaderStub{stats: &groupmodule.GroupStats{
			TotalTraces: 3,
			AvgDuration: 4.5,
		}},
		notify: notificationReaderStub{},
